...
import { CookiesResponsive } from "@/app/(nonce)/(artikler)/informasjonskapsler/CookiesResponsive";
import { NECESSARY_COOKIES, OPTIONAL_COOKIES } from "@/app/(nonce)/(artikler)/informasjonskapsler/cookiesData";
import SkyraToggle from "@/app/(nonce)/(artikler)/informasjonskapsler/SkyraToggle";
import UmamiToggle from "@/app/(nonce)/(artikler)/informasjonskapsler/UmamiToggle";
