...
import { Locations } from "@/app/(nonce)/stillinger/(sok)/_utils/fetchLocationsWithinDrivingDistance";
import { SOMMERJOBB_SEARCH_RESULT_SIZE } from "@/app/(nonce)/sommerjobb/_utils/constants";
import { SOMMERJOBB_CATEGORIES, SOMMERJOBB_KEYWORDS } from "@/app/(nonce)/sommerjobb/_utils/searchKeywords";
