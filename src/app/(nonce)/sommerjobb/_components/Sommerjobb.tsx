...
import SommerjobbResults from "@/app/(nonce)/sommerjobb/_components/SommerjobbResults";
import GreenFlower from "@/app/(nonce)/sommerjobb/_components/icons/GreenFlower";
import RedFlower from "@/app/(nonce)/sommerjobb/_components/icons/RedFlower";
import { Postcode } from "@/app/(nonce)/stillinger/(sok)/_utils/fetchPostcodes";
import SommerjobbWorkCategory from "@/app/(nonce)/sommerjobb/_components/SommerjobbWorkCategory";
import SommerjobbDistance from "@/app/(nonce)/sommerjobb/_components/SommerjobbDistance";
import { SommerjobbResultData } from "@/app/(nonce)/sommerjobb/_utils/types/SommerjobbResultData";
