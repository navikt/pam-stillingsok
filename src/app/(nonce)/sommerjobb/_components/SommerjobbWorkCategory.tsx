...
import { JOB_CATEGORY_PARAM_NAME, PAGE_PARAM_NAME } from "@/app/(nonce)/sommerjobb/_utils/constants";
import { CoffeeIcon } from "@navikt/aksel-icons";
import { SOMMERJOBB_CATEGORIES } from "@/app/(nonce)/sommerjobb/_utils/searchKeywords";
