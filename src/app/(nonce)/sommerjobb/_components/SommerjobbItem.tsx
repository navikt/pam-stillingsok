...
import Employer from "@/app/(nonce)/sommerjobb/_components/icons/Employer";
import Location from "@/app/(nonce)/sommerjobb/_components/icons/Location";
import Calendar from "@/app/(nonce)/sommerjobb/_components/icons/Calendar";
