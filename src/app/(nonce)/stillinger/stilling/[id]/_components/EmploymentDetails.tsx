...
import joinStringWithSeparator from "@/app/(nonce)/stillinger/_common/utils/joinStringWithSeparator";
...
import { joinArbeidstider } from "@/app/(nonce)/stillinger/_common/utils/arbeidstid";
import { getStartText } from "@/app/(nonce)/stillinger/_common/lib/ad-model/utils/start-text";
