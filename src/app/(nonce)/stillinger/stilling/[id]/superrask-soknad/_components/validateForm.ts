import { isValidEmail, isValidTelephone } from "@/app/(nonce)/stillinger/_common/utils/utils";
import { Application, Qualification } from "@/app/(nonce)/stillinger/stilling/[id]/superrask-soknad/_types/Application";
