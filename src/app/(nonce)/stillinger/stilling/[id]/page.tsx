import { getAdData } from "@/app/(nonce)/stillinger/stilling/_data/adDataActions";
...
import { fetchCachedSimplifiedElasticSearch } from "@/app/(nonce)/stillinger/stilling/[id]/_similarity_search/fetchElasticSearch";
import { SimilarAdsSearchQuery } from "@/app/(nonce)/stillinger/stilling/[id]/_similarity_search/elasticSimilaritySearchRequestBody";
import { getDefaultHeaders } from "@/app/(nonce)/stillinger/_common/utils/fetch";
import { AdDTO } from "@/app/(nonce)/stillinger/_common/lib/ad-model";
import logger from "@/app/(nonce)/min-side/_common/utils/logger";
import { SimilaritySearchResultData } from "@/app/(nonce)/stillinger/stilling/[id]/_similarity_search/simplifySearchResponse";
