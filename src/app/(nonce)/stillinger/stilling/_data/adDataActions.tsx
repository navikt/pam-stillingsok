...
import { type AdDTO, elasticHitToAdDTOResult } from "@/app/(nonce)/stillinger/_common/lib/ad-model";
import { bestEffortFromHit } from "@/app/(nonce)/stillinger/_common/lib/ad-model/bestEffortFromHit";
