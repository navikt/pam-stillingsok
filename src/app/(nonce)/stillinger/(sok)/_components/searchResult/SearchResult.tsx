...
import FavouritesButton from "@/app/(nonce)/stillinger/favoritter/_components/FavouritesButton";
...
import { SEARCH_CHUNK_SIZE } from "@/app/(nonce)/stillinger/(sok)/_utils/query";
import SearchResultItem from "./SearchResultItem";
import { type SearchResult as SearchResultType } from "@/app/(nonce)/stillinger/_common/types/SearchResult";
import KarriereveiledningBanner from "@/app/(nonce)/stillinger/(sok)/_components/searchResult/KarriereveiledningBanner";
