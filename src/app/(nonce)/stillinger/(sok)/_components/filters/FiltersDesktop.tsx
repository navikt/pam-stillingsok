...
import Remote from "@/app/(nonce)/stillinger/(sok)/_components/filters/Remote";
import Education from "@/app/(nonce)/stillinger/(sok)/_components/filters/Education";
import DriversLicense from "@/app/(nonce)/stillinger/(sok)/_components/filters/DriversLicense";
import Experience from "@/app/(nonce)/stillinger/(sok)/_components/filters/Experience";
import DistanceOrLocation from "@/app/(nonce)/stillinger/(sok)/_components/filters/DistanceOrLocation";
...
import Under18 from "@/app/(nonce)/stillinger/(sok)/_components/filters/Under18";
