import { createQuery, SEARCH_CHUNK_SIZE, SearchQuery, toApiQuery } from "@/app/(nonce)/stillinger/(sok)/_utils/query";
import { fetchCachedSimplifiedElasticSearch } from "@/app/(nonce)/stillinger/(sok)/_utils/fetchElasticSearch";
import { z } from "zod";
import React from "react";
import MaxQuerySizeExceeded from "@/app/(nonce)/stillinger/(sok)/_components/maxQuerySizeExceeded/MaxQuerySizeExceeded";
import { fetchCachedPostcodes, Postcode } from "@/app/(nonce)/stillinger/(sok)/_utils/fetchPostcodes";
import SearchWrapper from "@/app/(nonce)/stillinger/(sok)/_components/SearchWrapper";
import { getDefaultHeaders } from "@/app/(nonce)/stillinger/_common/utils/fetch";
import { unstable_cache } from "next/cache";
import { logTextSearch } from "@/app/(nonce)/stillinger/_common/monitoring/search-logging";
...
import {
    ...
    FetchError,
    FetchResult,
} from "@/app/(nonce)/stillinger/(sok)/_utils/fetchTypes";
