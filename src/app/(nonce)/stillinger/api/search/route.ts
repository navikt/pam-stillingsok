import { createQuery, toApiQuery } from "@/app/(nonce)/stillinger/(sok)/_utils/query";
import { migrateSearchParams } from "@/app/(nonce)/stillinger/(sok)/_utils/versioning/searchParamsVersioning";
import { NextRequest, NextResponse } from "next/server";
import logger from "@/app/(nonce)/stillinger/_common/utils/logger";
import { fetchElasticSearch } from "@/app/(nonce)/stillinger/(sok)/_utils/fetchElasticSearch";
