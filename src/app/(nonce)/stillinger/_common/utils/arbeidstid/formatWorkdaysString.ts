import { parseStringList, type StringListInput } from "@/app/(nonce)/stillinger/_common/utils/text/listParsing";
import { dedupeStringsPreserveFirst } from "@/app/(nonce)/stillinger/_common/utils/text/dedupe";
import { CANONICAL_MAP, CanonicalDay, DISPLAY_ORDER } from "@/app/(nonce)/stillinger/_common/utils/arbeidstid/index";
import { removeDiacriticsLower } from "@/app/(nonce)/stillinger/_common/utils/text/normalize";
import { formatNbList } from "@/app/(nonce)/stillinger/_common/utils/text/nbFormat";
