...
import { capitalizeFirst } from "@/app/(nonce)/stillinger/_common/utils/text/casing";
import { formatWorkdaysString, formatWorkTimeString } from "@/app/(nonce)/stillinger/_common/utils/arbeidstid/index";
