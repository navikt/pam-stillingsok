...
function adText(html: string): string {
    ...
    // 2) Beskytt eksisterende <a>...</a> så vi ikke wrap’er på nytt
    ...
    // 3) Linkify kun i tekstnoder (segmenter mellom >...<)
    ...
    // 4) Gjeninnsett beskyttede <a>-tags
...
export function sanitizeAdText(html: unknown): string | undefined {
