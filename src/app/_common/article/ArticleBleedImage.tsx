...
function ArticleBleedImage(props: ArticleBleedImageProps) {
    if (props.figcaption) {
        return (
            <figure className="article-image-figure mb-12">
                <Bleed marginInline={{ xs: "space-0", sm: "space-0", md: "space-128" }} className="mb-2 image-wrapper">
    ...
    return (
        <Bleed marginInline={{ xs: "space-0", sm: "space-0", md: "space-128" }} className="mb-8 image-wrapper">
            <Image {...props} className={cn("article-image", props.className)} fill quality={90} />
        </Bleed>
    );
}
