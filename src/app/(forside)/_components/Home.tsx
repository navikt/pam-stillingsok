...
export default function Home() {
    return (
        <>
            <PageBlock width="xl" gutters className="mt-5 mb-12">
            ...
            <PageBlock width="xl" gutters className="mb-12">
            ...
            <PageBlock width="xl" gutters className="mb-12" data-nosnippet="true">
