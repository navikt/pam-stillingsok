...
export default function HuskDetteNarDuBrukerKIISoknadenDin({ meta }: Props) {
    return (
        <>
            <ArticleWrapper lang={meta.language}>
                ...
                <BodyLong spacing>
                    Mange bruker kunstig intelligens (KI) når de skal søke jobb, for eksempel Copilot og ChatGPT. Det
                    kan være nyttig, men vi må som alltid bruke KI på en bevisst og kritisk måte.
                </BodyLong>
                ...
                <BodyLong spacing>
                    ...
                    unik. Derfor må du alltid gå gjennom teksten selv og sørge for at den er riktig. KI kan også ta
                    feil. Den kan finne på erfaringer, ferdigheter eller formuleringer som ikke passer for deg. Spør deg
                    selv:
                </BodyLong>
                <List className="mb-6">
                ...
                <BodyLong spacing>
                    Setninger og tekst som KI foreslår, kan noen ganger være litt stive eller &quot;robotaktige&quot;.
                    Det er blant annet fordi KI ofte bruker engelske tekster som utgangspunkt for sine svar. Da
                    oversetter den direkte fra engelsk, og plutselig dukker det kanskje opp noen litt uvante
                    formuleringer.
                </BodyLong>

                <BodyLong spacing>
                    Det kan være vanskelig å legge merke til dette. Les derfor nøye gjennom teksten, og få gjerne hjelp
                    av noen andre til å se over.
                </BodyLong>

                <BodyLong className="mb-6">
                    Arbeidsgivere merker fort om søknaden din ikke er personlig, og kun er skrevet av KI. Det viktigste
                    er å beskrive dine faktiske erfaringer, slik du selv ville gjort:
                </BodyLong>
                ...
                <BodyLong spacing>
                    For at KI skal gjøre det du vil, må du skrive gode instrukser. En instruks, også kalt prompt, er det
                    du skriver til KI-en for å fortelle hva den skal gjøre. Jo tydeligere instruks, jo bedre svar.
                </BodyLong>
                ...
                <List className="mb-8">
                    ...
                    <ListItem>
                        Be KI lese gjennom teksten og komme med kritiske spørsmål til det du har skrevet.
                    </ListItem>
                ...
                <BodyLong spacing>
                    Derfor er det viktig at du ikke legger inn personopplysninger eller andre detaljer du ikke ønsker å
                    dele videre. Personopplysninger er informasjon som kan brukes til å kjenne igjen en person. For
                    eksempel navn, bilde, fødselsnummer, telefonnummer eller helseopplysninger. Hold deg til det som er
                    nødvendig for søknaden.
                </BodyLong>
