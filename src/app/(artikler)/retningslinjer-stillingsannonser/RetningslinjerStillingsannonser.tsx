    ...
    return (
        <ArticleWrapper lang={meta.language}>
            ...
            <List className="mb-6" aria-label="Et ansettelsesforhold er blant annet kjennetegnet ved at arbeidsgiver:">
                <ListItem>melder arbeidstaker inn i Arbeidsgiver-/arbeidstakerregisteret</ListItem>
                <ListItem>foretar forskuddstrekk av skatt</ListItem>
                <ListItem>er ansvarlig for arbeidsmiljøet arbeidstakeren oppholder seg i</ListItem>
            </List>
            <BodyLong className="mb-12">
