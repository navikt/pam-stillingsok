    ...
    return (
        <article lang={meta.language !== "nb" ? meta.language : undefined} className="container-small">
            <div>
                ...
                <div className="mb-16">
                    <BodyLong spacing>
                        Informasjonskapsler (cookies og liknande teknologiar) er små datafiler som blir lagra på eininga
                        di når du nyttar nettsida vår. Nokre av dei er nødvendige for at nettsida skal fungera korrekt
                    ...
                    <BodyLong spacing>
                        ...
                        informasjonskapslane blir alltid sette og kan ikkje skruast av. For valfrie kan du skru analyse
                        og statistikk (Umami) av/på:
                    </BodyLong>
                    ...
                    <List aria-label="Hva bruker vi umami til">
                        ...
                        <List.Item>
                            IP-adresser blir maskerte, og data blir ikkje delte med reklamenettverk eller eksterne
                    ...
                    <BodyLong spacing>
                        Me bruker <strong>Skyra</strong> for å gjennomføra korte spørjeundersøkingar og for å forstå kva
                        som fungerer og kva me bør forbetra på arbeidsplassen.no.
                    </BodyLong>
                    ...
                    <BodyLong>
                        Du kan når som helst endra innstillingane dine for informasjonskapslar via «Endre samtykke»
                        eller via personvernerklæringa vår.
                    </BodyLong>
                </div>
            </div>
        </article>
