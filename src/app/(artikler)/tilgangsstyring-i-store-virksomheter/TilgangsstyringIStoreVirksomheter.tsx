    ...
    return (
        <>
            <ArticleWrapper lang={meta.language}>
                ...
                <BodyLong spacing>
                    Verksemder kan ha utfordringar med å handtera tilgangsstyring, spesielt når organisasjonen er stor
                    og kompleks. Tilsette kan oppleva at det er vanskeleg å finna ut kven i organisasjonen som kan gi
                    tilgang. Det er stor avstand mellom dei som skal ha tilgang og dei som har styresmakt til å
                    delegera.
                </BodyLong>
                <BodyLong spacing>
                    På same måte kan dei som har styresmakt til å delegera oppleva det som krevjande å halda oversikt
                    over medarbeidarar og kva tilgangar dei har eller skal ha.
                </BodyLong>
                <Heading size="medium" level="3" spacing>
                    Verksemda mi har verksemdssertifikat, kan me bruka det på arbeidsplassen.no?
                </Heading>
                <BodyLong spacing>
                    Nei, dette sertifikatet kan ikkje brukast. Tilgang til arbeidsplassen.no og kandidatlister frå Nav
                    på Mi side Arbeidsgiver kan berre givast i Altinn.
                </BodyLong>
                <Heading size="medium" level="3" spacing>
                    Tilgang til heile eller delar av organisasjonen?
                </Heading>
                <BodyLong spacing>
                    Tilgangsstyringa på arbeidsplassen.no og kandidatlister frå Nav er basert på undereining.
                    Arbeidsgivarar som gir tilgang, vel i Altinn om tilgangen skal vera avgrensa til ein eller fleire
                    undereiningar, eller omfatta hovudeininga inkludert alle undereiningar. Det er altså ikkje nødvendig
                    å gi personar tilgang til heile organisasjonen.
                </BodyLong>
                <BodyLong spacing>
                    Dersom det er ønskjeleg at ein medarbeidar skal ha tilgang til alle undereiningar, er det praktisk
                    for den som gir tilgang å kunna gi éin tilgang til hovudeining, som automatisk gir tilgang for alle
                    undereiningar.
                </BodyLong>
                <Heading size="medium" level="3" spacing>
                ...
                <BodyLong spacing>
                    ...
                    administrerer tilgangsstyring i Altinn. Ofte er denne oppgåva delegert til mellomleiarar eller HR.
                    Det finst nokre praktiske måtar å løysa det på ved hjelp av rollene Tilgangsstyring og eventuelt
                ...
                <BodyLong spacing>
                    ...
                    Tilgangsstyring. Denne rolla kan tildela rettar i organisasjonen. Merk at ein person som skal ha
                    rolla Tilgangsstyring, sjølv må ha dei rollene/rettane hen skal administrera. Ein tilgangsstyrar må
                    derfor ha enkeltretten «Stillingsannonsar på arbeidsplassen.no» og/eller rollene Lønn og
                    personalmedarbeidar eller Utfyller/ Innsender, for å kunna gi andre den same retten som vil gi
                    tilgang som arbeidsgivar til arbeidsplassen.no og kandidatlister frå Nav.
                </BodyLong>
                <Heading size="medium" level="3" spacing>
                    Korleis fungerer rolla Hovedadministrator?
                </Heading>
                <BodyLong spacing>
                    Viss verksemda ønskjer at éin nøkkelperson skal administrera alle Altinn-rettar på vegner av
                    verksemda, er løysinga rolla Hovedadministrator. Styrets leiar, styrande reidar eller innehavar kan
                    etablera denne rolla.
                </BodyLong>
                <BodyLong spacing>
                ...
                <BodyLong spacing>
                    Hovudadministrator kan også gi ein eller fleire medarbeidarar rolla Tilgangsstyring.
                    Hovudadministrator tek då ei overordna rolle, og tilgangsstyrarar administrerer roller og rettar,
                    til dømes enkeltretten «Stillingsannonsar på arbeidsplassen.no».
                </BodyLong>
                <BodyLong spacing>
                    Les meir om{" "}
                ...
                <ul>
                    ...
                    <li>
                        <BodyLong>
                            ...
                            finnar du oversikt over roller eller enkeltrettar som ulike Nav-tenester krev. Når du er
                            logga inn vil du finna moglegheit for å “be om tilgang”.
                        </BodyLong>
                    </li>
                </ul>
                <BodyLong spacing>
                    Om du ikkje har høve til å be om tilgang som beskrivne, må du sjølv finna ut kven i HR eller leiinga
                    som kan gi deg tilgang.
                </BodyLong>
                <Heading size="large" level="2" spacing>
                ...
                <ul>
                    <li>
                        <BodyLong>
                            Om du er registrert i Einingsregisteret som daglig leiar, styrets leiar, styrande reidar
                            eller innehavar, vil du automatisk ha alle tilgangar som du kan gi vidare til andre.
                        </BodyLong>
                    </li>
                    <li>
                        <BodyLong>
                    ...
                    <li>
                        <BodyLong>
                            Har du rolla Tilgangsstyrar, kan du gi andre medarbeidarar dei tilgangane dei treng,
                            føresett at du sjølv har dei rettane du skal tildela til andre (enkeltretten
                            «Stillingsannonsar på arbeidsplassen.no», eller Altinn-rolle Lønn og personalmedarbeidar,
                            eller Altinn-rolle Utfyller/innsendar).
                        </BodyLong>
                    </li>
                </ul>
                <BodyLong spacing>
                ...
                <BodyLong spacing>
                    Enkeltretten «Stillingsannonsar på arbeidsplassen.no» gir tilgang til å bruka stillingsregistrering
                    og superrask søknad på arbeidsplassen.no. Denne retten gir ikkje tilgang til å få CVer. Då kan du
                    som arbeidsgivar vita at ein medarbeidar ikkje får tilgang til andre tenester. Om du tildeler rolla
                    Lønn og personalmedarbeidar eller Utfyller/Innsender, er det vide tilgangar som gir tilgang til
                    fleire tenester enn berre arbeidsplassen.no og kandidatlister frå Nav.
                </BodyLong>
                <Heading size="medium" level="3" spacing>
                ...
                <BodyLong spacing>
                    Enkeltretten «Stillingsannonsar på arbeidsplassen.no» gir tilgang til å bruka stillingsregistrering
                    og superrask søknad på arbeidsplassen.no. Denne retten gir ikkje tilgang til å få CVer. Tildeler du
                    enkeltretten «Stillingsannonsar på arbeidsplassen.no», kan du vera sikker på at du ikkje gir tilgang
                    til andre tenester enn Navs rekrutteringstenester.
                </BodyLong>
                <Heading size="medium" level="3" spacing>
