...
function GroupItem({ children, color = "surface-neutral-subtle", tag }) {
    return (
        <Box background={color} paddingInline={tag ? "2 1" : "2"} paddingBlock="1" borderRadius="small">
            <HStack align="center" gap="2">
                <BodyShort size="small" weight="semibold">
                    {children}
                </BodyShort>
                {tag && (
                    <Box paddingBlock="05" borderRadius="small" paddingInline="1" background="surface-neutral-subtle">
