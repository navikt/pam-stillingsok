...
function Locations({ locations, query, dispatch, updatedValues }) {
    ...
    function handleLocationClick(value, type, checked) {
        if (type === "county") {
            ...
            logFilterChanged({ name: "Sted", value: fixLocationName(value), checked, level: "county" });
            ...
            logFilterChanged({ name: "Sted", value: fixLocationName(value, true), checked, level: "municipal" });
            ...
            logFilterChanged({ name: "Sted", value: fixLocationName(value), checked, level: "country" });
