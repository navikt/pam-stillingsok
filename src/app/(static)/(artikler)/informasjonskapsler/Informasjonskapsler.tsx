...
import { CookiesResponsive } from "@/app/(static)/(artikler)/informasjonskapsler/CookiesResponsive";
import { NECESSARY_COOKIES, OPTIONAL_COOKIES } from "@/app/(static)/(artikler)/informasjonskapsler/cookiesData";
import SkyraToggle from "@/app/(static)/(artikler)/informasjonskapsler/SkyraToggle";
import UmamiToggle from "@/app/(static)/(artikler)/informasjonskapsler/UmamiToggle";
