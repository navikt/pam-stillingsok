...
const Interest = ({ match }) => {
    ...
    return (
        <div className="Interest">
            ...
            <H1WithAutoFocus className="Interest__h1">
                👏
                <br /> Du har funnet en ny funksjon som vi holder på å utvikle!
            </H1WithAutoFocus>
            <p>
            ...
            <p>
                <b>
                    NB! Dette har ikke noe å gjøre med den spesifikke stillingen du var inne på. Denne henvendelsen
                    gjelder bare en frivillig brukertest for arbeidsplassen.no
                </b>
            </p>
            <a
