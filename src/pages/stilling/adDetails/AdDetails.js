        ...
        <div className="AdDetails detail-section">
            ...
            <div className="detail-section__body">
                <dl className="dl-flex typo-normal">
                    ...
                    {source.medium && [<dt key="dt">Hentet fra:</dt>, <dd key="dd">{source.medium}</dd>]}
                    {source.reference && [<dt key="dt">Referanse:</dt>, <dd key="dd">{source.reference}</dd>]}
                    {source.id && [<dt key="dt">Stillingsnummer:</dt>, <dd key="dd">{source.id}</dd>]}
                </dl>
