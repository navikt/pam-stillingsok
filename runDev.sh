...
export TOKEN_X_WELL_KNOWN_URL=http://host.docker.internal:1337/tokenx/.well-known/openid-configuration
export IDPORTEN_WELL_KNOWN_URL=http://host.docker.internal:1337/idporten/.well-known/openid-configuration
export TOKEN_X_CLIENT_ID=local-token-x-client-id
export TOKEN_X_ISSUER=http://host.docker.internal:1337/tokenx
export TOKEN_X_TOKEN_ENDPOINT=http://host.docker.internal:1337/tokenx/token
export IDPORTEN_JWKS_URI=http://host.docker.internal:1337/idporten/jwks
